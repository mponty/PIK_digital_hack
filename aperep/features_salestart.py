...
for i, m in enumerate(mm):
    ...
    # cur_in_sale = cur_in_sale[cur_in_sale['date_salestart'] < cur_m]
    ...
    f_salestart = f_salestart.drop(['new_still_sale2', 'sum_still_sale2', 'idle_square2', 'shadow_start_square2'], axis=1)
