...
q_periods = {
    ('2015-06-01', '2015-07-01'): ['2015-07-01'],
    ('2015-07-01', '2015-08-01'): ['2015-08-01'],
    ('2015-08-01', '2015-09-01'): ['2015-09-01'],
    ('2015-09-01', '2015-10-01'): ['2015-10-01'],
    ('2015-10-01', '2015-11-01'): ['2015-11-01'],
    ('2015-11-01', '2015-12-01'): ['2015-12-01'],

    ('2015-12-01', '2016-01-01'): ['2016-01-01'],
    ('2016-01-01', '2016-02-01'): ['2016-02-01'],
    ('2016-02-01', '2016-03-01'): ['2016-03-01'],
    ('2016-03-01', '2016-04-01'): ['2016-04-01'],
    ('2016-04-01', '2016-05-01'): ['2016-05-01'],
    ('2016-05-01', '2016-06-01'): ['2016-06-01'],
    ('2016-06-01', '2016-07-01'): ['2016-07-01'],
    ('2016-07-01', '2016-08-01'): ['2016-08-01'],
    ('2016-08-01', '2016-09-01'): ['2016-09-01'],
    ('2016-09-01', '2016-10-01'): ['2016-10-01'],
    ('2016-10-01', '2016-11-01'): ['2016-11-01'],
    ('2016-11-01', '2016-12-01'): ['2016-12-01'],

    ('2016-12-01', '2017-01-01'): ['2017-01-01'],
    ('2017-01-01', '2017-02-01'): ['2017-02-01'],
    ('2017-02-01', '2017-03-01'): ['2017-03-01'],
    ('2017-03-01', '2017-04-01'): ['2017-04-01'],
    ('2017-04-01', '2017-05-01'): ['2017-05-01'],
    ('2017-05-01', '2017-06-01'): ['2017-06-01'],
    ('2017-06-01', '2017-07-01'): ['2017-07-01'],
    ('2017-07-01', '2017-08-01'): ['2017-08-01'],
    ('2017-08-01', '2017-09-01'): ['2017-09-01'],
    ('2017-09-01', '2017-10-01'): ['2017-10-01'],
    ('2017-10-01', '2017-11-01'): ['2017-11-01'],
    ('2017-11-01', '2017-12-01'): ['2017-12-01'],

    ('2017-12-01', '2018-01-01'): ['2018-01-01'],
    ('2018-01-01', '2018-02-01'): ['2018-02-01'],
    ('2018-02-01', '2018-03-01'): ['2018-03-01'],
    ('2018-03-01', '2018-04-01'): ['2018-04-01'],
    ('2018-04-01', '2018-05-01'): ['2018-05-01'],
    ('2018-05-01', '2018-06-01'): ['2018-06-01'],
}
...
# what_we_want = pd.DataFrame(columns=['id_bulk', 'spalen', 'date1', 'ratio_zar'])
# what_we_want['date1'] = what_we_want['date1'].astype(str)
# what_we_want = what_we_want.insert({'id_bulk':'1', 'spalen':2, 'date1':'dd', 'ratio_zar':1})

# to_concat = what_we_want.copy()
# to_concat = to_concat[['id_bulk', 'spalen']]
# to_concat['id_bulk'] = flat_df[['id_bulk']].drop_duplicates()['id_bulk']
# to_concat['spalen'] = flat_df[['id_bulk', 'spalen']].drop_duplicates()['spalen']
...
for d1, d123 in q_periods.items():
    ...
    v_re_1 = v_re_1.groupby(['id_bulk', 'spalen'], as_index=False).agg({'id_flatwork': lambda s: s.drop_duplicates().values.shape[0]})
    ...
    # sold_in_quarter = sold_in_quarter.groupby(['id_bulk', 'spalen'], as_index=False).agg({'id_flatwork': lambda s: s.drop_duplicates().values.shape[0]})
    ...
    for dd in d123:
        ...
        ff = pd.merge(left=ff, right=v_re_1, on=['id_bulk', 'spalen', 'date1'], how='left')
        ff = ff.fillna(0)
...
ff.to_csv('features_status_month1.csv', index=False)
