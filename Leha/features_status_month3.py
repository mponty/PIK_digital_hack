...
for mm in range(5, 37, 3):
    print("('201{}-{:02d}-01', '201{}-{:02d}-01'): ['201{}-{:02d}-01', '201{}-{:02d}-01', '201{}-{:02d}-01'],"
          .format(5+(mm)//12, (mm)%12 + 1,
            5+(mm+3)//12, (mm+3) % 12 + 1,
            5+(mm+3)//12, (mm+3) % 12 + 1,
            5+(mm+4)//12, (mm+4) % 12 + 1,
            5+(mm+5)//12, (mm+5) % 12 + 1))
...
# semifinals
# q_periods = {
#     ('2015-05-01', '2015-08-01'): ['2015-08-01', '2015-09-01', '2015-10-01'],
...
# }
q_periods = {
    ('2015-06-01', '2015-09-01'): ['2015-09-01', '2015-10-01', '2015-11-01'],
    ('2015-09-01', '2015-12-01'): ['2015-12-01', '2016-01-01', '2016-02-01'],
    ('2015-12-01', '2016-03-01'): ['2016-03-01', '2016-04-01', '2016-05-01'],
    ('2016-03-01', '2016-06-01'): ['2016-06-01', '2016-07-01', '2016-08-01'],
    ('2016-06-01', '2016-09-01'): ['2016-09-01', '2016-10-01', '2016-11-01'],
    ('2016-09-01', '2016-12-01'): ['2016-12-01', '2017-01-01', '2017-02-01'],
    ('2016-12-01', '2017-03-01'): ['2017-03-01', '2017-04-01', '2017-05-01'],
    ('2017-03-01', '2017-06-01'): ['2017-06-01', '2017-07-01', '2017-08-01'],
    ('2017-06-01', '2017-09-01'): ['2017-09-01', '2017-10-01', '2017-11-01'],
    ('2017-09-01', '2017-12-01'): ['2017-12-01', '2018-01-01', '2018-02-01'],
    ('2017-12-01', '2018-03-01'): ['2018-03-01', '2018-04-01', '2018-05-01'],
}
...
ff.to_csv('features_status_month3.csv', index=False)
