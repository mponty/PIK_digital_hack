...
features_status2 = pd.read_csv('features_status_month2.csv')
...
features_status1 = pd.read_csv('features_status_month1.csv')
train = pd.merge(left=train, right=features_status1, on=['bulk_id', 'spalen', 'date1'], how='left')
test = pd.merge(left=test, right=features_status1, on=['bulk_id', 'spalen', 'date1'], how='left')
...
features_values2 = pd.read_csv('features_values_month2.csv')
...
features_values1 = pd.read_csv('features_values_month1.csv')
train = pd.merge(left=train, right=features_values1, on=['bulk_id', 'spalen', 'date1'], how='left')
test = pd.merge(left=test, right=features_values1, on=['bulk_id', 'spalen', 'date1'], how='left')
...
train.to_csv('FINAL_TRAIN_month1.csv', index=False)
test.to_csv('FINAL_TEST_month1.csv', index=False)
